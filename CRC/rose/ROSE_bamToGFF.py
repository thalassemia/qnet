...
def mapBamToGFF(bamFile,gff,sense = 'both',extension = 200,floor = 0,rpm = False,matrix = None):
    ...
    p = Pool(cpu_count())
    g = partial(mapFunc,bam=bam,newGFF=newGFF,MMR=MMR,hasChrFlag=hasChrFlag,sense=sense,extension=extension,floor=floor,rpm=rpm,matrix=matrix)
...
def mapFunc(gff,bam,newGFF,MMR,hasChrFlag,sense = 'both',extension = 200,floor = 0,rpm = False,matrix = None):    
