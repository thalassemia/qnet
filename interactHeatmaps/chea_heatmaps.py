...
data = load_data("chea_models")
np.savetxt("/u/home/s/seanchea/plots/cmax.csv", data[1], delimiter=",")
np.savetxt("/u/home/s/seanchea/plots/cavg.csv", data[0], delimiter=",")
heatmap(data[2], data[1], 0.1, "chea_max")
heatmap(data[2], data[0], 0.01, "chea_avg")