...
data = load_data("lisa_models")
np.savetxt("/u/home/s/seanchea/plots/lmax.csv", data[1], delimiter=",")
np.savetxt("/u/home/s/seanchea/plots/lavg.csv", data[0], delimiter=",")
heatmap(data[2], data[1], 0.1, "lisa_max")
heatmap(data[2], data[0], 0.01, "lisa_avg")